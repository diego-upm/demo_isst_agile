# TC-03 - Control de autorizacion por rol
...
$resp = Invoke-Api -Method "GET" -Path "/rrhh/me" -Token $proToken
Assert-Status "TC-03 Profesional no puede acceder a recurso RRHH" $resp @(401,403)
