# TC-10 - Consulta y edicion del perfil profesional propio
...
$proToken = Login "pro@agileict.local" "demo1234"
$me = Invoke-Api -Method "GET" -Path "/profesionales/me" -Token $proToken
if ($me.Status -ne 200) { Assert-Status "TC-10 Consultar perfil profesional" $me @(200) }

$body = @{
    nombre="Test";
    apellidos="Profesional";
    tecnologiasClave="Java, Spring Boot, PostgreSQL, Docker";
    titulacionesAcademicas="Grado en Ingenieria";
    idiomas="Espanol, Ingles";
    softSkills="Comunicacion, liderazgo";
    aniosExperiencia=9;
    rangoSalarialEsperadoMin=46000;
    rangoSalarialEsperadoMax=68000;
    descripcionPersonal="Perfil actualizado por TC-10";
    areaNegocio="TECNOLOGIA_IT";
    disponibilidad="AVAILABLE";
    perfilVisible=$true
}
$resp = Invoke-Api -Method "PUT" -Path "/profesionales/me" -Body $body -Token $proToken
Assert-Status "TC-10 Actualizar perfil profesional propio" $resp @(200)
