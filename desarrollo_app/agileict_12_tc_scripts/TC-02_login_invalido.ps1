# TC-02 - Rechazo de autenticacion con credenciales invalidas
...
$resp = Invoke-Api -Method "POST" -Path "/auth/login" -Body @{ email="rrhh@agileict.local"; password="password_mal" }
Assert-Status "TC-02 Login invalido sin token" $resp @(400,401,403)
