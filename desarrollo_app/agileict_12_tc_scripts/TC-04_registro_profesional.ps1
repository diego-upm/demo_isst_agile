# TC-04 - Registro de Profesional Senior
...
$body = @{
    nombre="Test"; apellidos="Profesional $Uniq"; email="profesional.$Uniq@test.local"; password="demo1234";
    tecnologiasClave="Java, Spring Boot, PostgreSQL";
    titulacionesAcademicas="Grado en Ingenieria";
    idiomas="Espanol, Ingles";
    softSkills="Comunicacion, liderazgo";
    aniosExperiencia=8;
    rangoSalarialEsperadoMin=45000;
    rangoSalarialEsperadoMax=65000;
    descripcionPersonal="Perfil senior creado por TC-04";
    areaNegocio="TECNOLOGIA_IT"
}
$resp = Invoke-Api -Method "POST" -Path "/auth/register-professional" -Body $body
Assert-Status "TC-04 Registro profesional valido" $resp @(201)
