...
public class ProfesionalSenior extends BaseEntity {
    ...
    @Column(name = "area_negocio", nullable = false, length = 64)
    private AreaNegocioProfesional areaNegocio;
    ...
    public AreaNegocioProfesional getAreaNegocio() {
        return areaNegocio;
    }
    ...
    public void setAreaNegocio(AreaNegocioProfesional areaNegocio) {
